...
$config['tables']['perfiles']        = 'perfil';
$config['tables']['estados']         = 'gq_estados';
$config['tables']['estados_producto']= 'gq_estados_producto';
$config['tables']['users_groups']    = 'users_groups';
$config['tables']['users_perfiles']  = 'users_perfiles';
$config['tables']['login_attempts']  = 'login_attempts';
$config['tables']['accion']	         = 'accion';
$config['tables']['pedidos']	     = 'gq_pedidos';
$config['tables']['productos']	     = 'gq_productos';
$config['tables']['empresas']	     = 'gq_empresas';
$config['tables']['robos']		     = 'gq_robo';
$config['tables']['seguros']	     = 'gq_seguros';
...
$config['join']['perfiles'] = 'perfil_id';
