		...
		<!-- Note: This width of the aside area can be adjusted through LESS variables -->
			...
			<nav>		
				<ul>
					<!--
					<li class="">
						<a href="<?php echo base_url('dashboard.php/dashboard/getAjax/dashboard'); ?>" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Dashboard</span></a>
					</li>
					-->
					{menu}
						<li>
							<a href="{link}"><i class="fa fa-lg fa-fw fa-{icono_menu}"></i> <span class="menu-item-parent">{nombre_menu}</span></a>
							{sub_menu}
								<ul>
									{items}
									<li>
										<a href="{link_submenu}">{nombre_submenu}</a>
									</li>
									{/items}
								</ul>
							{/sub_menu}
				...
				<ul>
					...
					<li>
						...
						<ul>
							<li>
								<a href="<?php echo base_url('dashboard.php/dashboard/getAjax/configuraciones'); ?>">Flot Chart</a>
							</li>
							<li>
								<a href="<?php echo base_url('assets/ajax/morris.html'); ?>">Morris Charts</a>
							</li>
							<li>
