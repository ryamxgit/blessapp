		...
		<!-- FAVICONS -->
		<link rel="shortcut icon" href="<?php echo base_url('assets/site/img/favicon.png'); ?>" type="image/x-icon">
		<link rel="icon" href="<?php echo base_url('assets/site/img/favicon.png'); ?>" type="image/x-icon">
