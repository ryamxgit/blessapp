...
<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<div class="jarviswidget jarviswidget-color-darken" id="wid-id-001" data-widget-editbutton="false" data-widget-fullscreenbutton="true">
		...
		?>
		<div class="text-right"><nav><a href="<?php echo site_url('dashboard/getAjax/crearActivacion');?>">Ingresar nueva Activaci&oacute;n</a></nav></div>
		<?php } ?>
	</div>
	<!-- end widget -->
...
<?php if ($hayDatos) { ?>
		...
		$(document).ready(function() {
			...
			*/	
		    ...
		    // custom toolbar
		    $("div.toolbar").html('<div class="text-right"><nav><a href="getAjax/crearActivacion">Ingresar nueva Activaci&oacute;n</a></nav></div>');
		    // Apply the filter
