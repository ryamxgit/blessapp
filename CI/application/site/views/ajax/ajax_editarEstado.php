							...
							<fieldset>
								<div class="row">
									<section class="col col-6">
										<label class="input">
											<input type="text" name="name" placeholder="Nombre" value="<?php echo $estado_name;?>" />
										</label>
									</section>
								</div>
							</fieldset>
...
<script type="text/javascript">
	...
	var $registerForm = $("#smart-form-register").validate({
				...
				var save = function() {
					...
					var url = "<?php echo base_url('dashboard/getAjax/editarEstado/')."/".$estado_id; ?>";
					var return_url = "<?php echo base_url('dashboard/getAjax/estados'); ?>";
