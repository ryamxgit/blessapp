							...
							<fieldset>
								<div class="row">
									<section class="col col-6">
										<label class="input">
											<input type="text" name="name" placeholder="Nombre" value="<?php echo $perfil_name;?>">
										</label>
									</section>
									<section class="col col-6">
										<label class="input">
											<input type="text" name="description" placeholder="Descripción" value="<?php echo $perfil_description;?>">
										</label>
									</section>
								</div>
							</fieldset>
								...
								<div class="form-horizontal row">
									<div class="col-md-10" style="margin-left: 40px;">
										...
										<label class="checkbox-inline">
											<?php echo form_dropdown('accion', $acciones, $currentAccion);?>              
										</label>
									</div>
								</div>
							</fieldset>
...
<script type="text/javascript">
	...
	var $registerForm = $("#smart-form-register").validate({
				...
				messages : {
					...
					accion : {
						required : 'Por favor elija una accion'
					}
				},
				...
				var save = function() {
					...
					var url = "<?php echo base_url('dashboard/getAjax/editarPerfil/'.$perfil_id); ?>";
