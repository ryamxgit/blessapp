										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>
												<tr>
													<th>ID</th>
													<th>Categoria</th>
													<th><i class="fa fa-fw fa-phone text-muted hidden-md hidden-sm hidden-xs"></i> Nombre</th>
													<th><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Usuario </th>
													<th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Fecha Creacion</th>													
													<th><i class="fa fa-fw fa-calendar txt-color-blue hidden-md hidden-sm hidden-xs"></i> Fecha Modif.</th>
